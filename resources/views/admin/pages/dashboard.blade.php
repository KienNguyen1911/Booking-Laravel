                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="admin/img/small-logos/logo-xd.svg" class="avatar avatar-sm me-3"
                                                        alt="xd">
                                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-wrapper w-75 mx-auto">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-primary w-10" role="progressbar"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="admin/img/small-logos/logo-jira.svg" class="avatar avatar-sm me-3"
                                                        alt="jira">
                                                </div>
                                                <div class="d-flex flex-column justify-content-center">
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-wrapper w-75 mx-auto">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-primary w-25" role="progressbar"
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <div class="progress-wrapper w-75 mx-auto">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-gradient-primary w-40" role="progressbar"
